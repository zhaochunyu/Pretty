	...
	myIDs.forEach(function(myID, index) {
				if (myID == "_") {
					...
					SelectOAinfo
							.SeleEndTime(
									myID,
									function(err, end_time, run_name) {
															...
															function(err,
																...
																if (serverIP) {
																	...
																	if (serverIP.data_708 == ''
																			|| serverIP.data_708 == null) {
																		logger
																				.info((serverIP.data_1011)
																						.substring(((serverIP.data_1011)
																								.lastIndexOf('/')) + 1));
																		var datainfo = {
																			'filename' : (serverIP.data_1011)
																					.substring(((serverIP.data_1011)
																							.lastIndexOf('/')) + 1),
